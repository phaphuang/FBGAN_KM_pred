...
class WGAN_LangGP():
    ...
    def build_model(self):
        ...
        self.V_optimizer = optim.Adam(self.V.parameters(), lr=self.lr, betas=(0.5, 0.9))
    ...
    def load_model(self, directory = ''):
        ...
        self.V.load_state_dict(torch.load(V_file))
        return epoch_found
    ...
    def disc_train_iteration(self, real_data, logkm_data):
        ...
        return d_fake_err.data, d_real_err.data, gradient_penalty.data, d_err, logkm_err.data
    ...
    def train_model(self, load_dir):
        ...
        for epoch in range(self.n_epochs):
            for idx in range(n_batches):
                ...
                if counter % 10 == 9:
                    summary_str = 'Iteration [{}/{}] - loss_d: {}, loss_g: {}, w_dist: {}, grad_penalty: {}, loss_km: {}'\
                        .format(counter, total_iterations, (d_err.data).cpu().numpy(),
                        (g_err.data).cpu().numpy(), ((d_real_err - d_fake_err).data).cpu().numpy(), gp_np, logkm_err)
                    print(summary_str)
                    ...
                    plot_losses([V_losses], ["logkm"], self.sample_dir + "logkm.png")
                counter += 1
